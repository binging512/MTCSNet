...
def preprocess_MoNuSeg(image_dir, anno_dir, output_dir):
    ...
    output_semantic_dir = os.path.join(output_dir, 'semantics_v4')
...
def gen_weak_n_full_labels(image_dir, semantic_dir, output_dir):
    ...
    output_superpixel_dir = os.path.join(output_dir,'superpixels_v4')
    output_point_dir = os.path.join(output_dir,'points_v4')
    output_voronoi_dir = os.path.join(output_dir,'voronois_v4')
    output_weak_dir = os.path.join(output_dir, 'labels_v4/weak')
    output_weak_heat_dir = os.path.join(output_dir, 'labels_v4/weak_heatmap')
    output_inst_dir = os.path.join(output_dir, 'labels_v4/weak_inst')
    output_full_dir = os.path.join(output_dir, 'labels_v4/full')
    output_full_heat_dir = os.path.join(output_dir, 'labels_v4/full_heatmap')
...
if __name__=="__main__":
    ...
    semantic_dir = './data/MoNuSeg/train/semantics_v4'
