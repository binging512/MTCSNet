...
def gen_split_file(preprocess_dir, output_dir):
    ...
    img_dir = os.path.join(preprocess_dir, 'images')
    img_names = sorted(os.listdir(img_dir))
    val_list = random.sample(img_names, 200)
    ...
    save_path = os.path.join(output_dir,'train_cs_val_cs_iter0.json')
    ...
    save_path = os.path.join(output_dir,'train_cs_val_cs_iter0_fuse.json')
    json.dump(split_dict, open(save_path, 'w'), indent=2)
...
if __name__=="__main__":
    ...
    # preprocess_dir = './data/CellSeg'
    # output_dir = './data/splits'
    # gen_split_file_fine_grained(preprocess_dir, output_dir, brightfield_1_list+brightfield_2_list, save_type='bf')
    # gen_split_file_fine_grained(preprocess_dir, output_dir, DIC_list, save_type='dic')
    # gen_split_file_fine_grained(preprocess_dir, output_dir, fluorescent_list, save_type='fl')
    # gen_split_file_fine_grained(preprocess_dir, output_dir, PC_list, save_type='pc')
